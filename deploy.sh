...
echo
echo "Enter stats dashboard credentials:"
STATS_USER=$(prompt_required_secret "STATS_USER")
STATS_PASS=$(prompt_required_secret "STATS_PASS")

echo
ENABLE_MIXOLOGIST=$(prompt_with_default "Enable mixologist integration? (true/false)" "false")
...
ATTRACT_MODE=$(prompt_with_default "Enable attract mode? (true/false)" "false")
